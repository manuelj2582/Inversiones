...
const AdminDashboard = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {mostrarModalCapital && vendedoraSeleccionada && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-md w-full">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">✏️ Editar Capital</h3>
                ...
                onClick={async () => {
                  try {
                    ...
                    await firebaseOperations.actualizarVendedora(vendedoraSeleccionada, {
                      capitalDisponible: parseFloat(nuevoCapital),
                    });
      ...
      {mostrarModalEditarPrestamo && prestamoEditando && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-2xl p-6 w-full max-w-md">
            <h3 className="text-xl font-bold text-gray-800 mb-4">✏️ Editar Crédito</h3>
            ...
            <div className="space-y-4 mb-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Cuotas Pagadas:</label>
                <input
                  type="number"
                  value={prestamoEditando.cuotasPagadas || 0}
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    await firebaseOperations.actualizarPrestamo(mostrarModalEditarPrestamo, {
